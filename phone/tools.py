...
INSTRUCTIONS = (
    "Мост с iPhone и Apple Watch владельца. Здесь лежит всё здоровье из "
    "выгрузки Apple — не только шаги и сон: пульс, HRV, кольца, стадии сна, "
    "тренировки, давление, вес, еда, — плюс журнал звонков и метаданные "
    "переписки (кто, когда, сколько написал, без текста).\n"
    ...
    "phone_attention — там всё, что важно прямо сейчас. Конкретную метрику "
    "спрашивай через phone_health."
)
